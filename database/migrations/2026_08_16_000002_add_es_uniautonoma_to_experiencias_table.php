 ...
 * tenga experiencia uniautonoma". `MotorEscalafonDocenteService::mesesEnEscalon()` usa esta
 * bandera —no el nombre libre de la institución— para respaldar los meses de antigüedad exigidos
 * por escalón, porque coincidir por texto ("autónoma") sería frágil: el SNIES real tiene varias
 * universidades distintas con "Autónoma" en el nombre.
 */

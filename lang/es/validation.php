...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción de los mensajes de validación por defecto de Laravel.
    | lang_path() apunta a base_path('lang') desde Laravel 9+, así que este
    | archivo vive en UniDoc/lang/es/validation.php (no en resources/lang).
    |
    */
    ...
    'doesnt_end_with' => 'El campo :attribute no debe terminar en uno de los siguientes valores: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute indicado ha aparecido en una filtración de datos. Elige un :attribute diferente.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres legibles en español para los campos usados en los formularios
    | de autenticación y perfil. Los que no aparezcan aquí se muestran
    | humanizados (guiones bajos por espacios), en vez de en inglés.
    |
    */
    'attributes' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Traduce valores literales que Laravel inserta tal cual en el mensaje,
    | como el parámetro "today" de la regla before:today/after:today.
    |
    */
    'values' => [
        'fecha_nacimiento' => [

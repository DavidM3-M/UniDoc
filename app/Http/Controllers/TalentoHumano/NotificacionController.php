...
class NotificacionController extends Controller
{
    ...
    /**
     * Notifica al usuario que su contratación fue eliminada/cancelada, indicando el motivo.
     *
     * Casos contemplados:
     *  - 'desvinculacion':       el usuario ya estaba contratado y se desvincula.
     *  - 'contrato_no_iniciado': se generó el contrato pero no alcanzó a vincularse.
     *  - null (genérico):        cualquier otra eliminación de contratación.
     *
     * @param \App\Models\Usuario\User $usuario
     * @param string|null $motivo  Motivo de la eliminación de la contratación.
     * @param string|null $caso    Caso de la eliminación ('desvinculacion' | 'contrato_no_iniciado' | null).
     */
    public static function contratacionEliminada(User $usuario, ?string $motivo, ?string $caso = null): void
    {
        switch ($caso) {
            case 'desvinculacion':
                $asunto  = 'Desvinculación de tu contrato – UniDoc';
                $mensaje = 'Te informamos que tu vinculación ha finalizado y tu contrato ha sido dado de baja en UniDoc. '
                         . 'Ingresa a la plataforma o comunícate con Talento Humano para más información.';
                break;

            case 'contrato_no_iniciado':
                $asunto  = 'Tu contrato ha sido anulado – UniDoc';
                $mensaje = 'Te informamos que el contrato generado a tu nombre ha sido anulado antes de iniciar la vinculación. '
                         . 'Ingresa a la plataforma o comunícate con Talento Humano para más información.';
                break;

            default:
                $asunto  = 'Tu contratación ha sido eliminada – UniDoc';
                $mensaje = 'Te informamos que tu contratación registrada en UniDoc ha sido eliminada. '
                         . 'Ingresa a la plataforma o comunícate con Talento Humano para más información.';
                break;
        }

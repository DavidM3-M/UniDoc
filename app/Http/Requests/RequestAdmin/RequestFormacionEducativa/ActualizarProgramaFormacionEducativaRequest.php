...
class ActualizarProgramaFormacionEducativaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'institucion_nombre' => ['sometimes', 'required', 'string', 'max:255'],
            'nivel_formacion_academica_id' => ['sometimes', 'required', 'integer', 'exists:niveles_formacion_academica,id_nivel_formacion_academica'],

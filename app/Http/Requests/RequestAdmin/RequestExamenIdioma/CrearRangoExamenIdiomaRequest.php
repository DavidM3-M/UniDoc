...
class CrearRangoExamenIdiomaRequest extends FormRequest
{
    ...
    {
        return [
            'examen_idioma_id' => 'bail|required|integer|min:1|max:' . ClavePrimaria::SMALLINT_MAXIMO
                . '|exists:examenes_idioma,id_examen_idioma',
